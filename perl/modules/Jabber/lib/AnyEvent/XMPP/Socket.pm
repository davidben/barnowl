...
This module is a fork of AnyEvent::Socket from AnyEvent 6.1. The fork
is needed so tcp_connect returns the host obtained from the SRV
record. The value is needed to pass to SASL.
